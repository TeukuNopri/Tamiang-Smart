...
import com.tamiang.smart.models.LoginRequest
...
//            val device      = Build.MANUFACTURER.toString()
            ...
            Log.d("s", loginRequest.toString())

            pb_login.visibility = View.VISIBLE
            NetworkConfig.getInstance().cekLogin(loginRequest).enqueue(object : Callback<LoginResponse>{
                override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                    Log.d("Data", response.body()?.metaData.toString())
                }
